...
namespace Amazon.SellingPartnerAPIAATests
{
    public class UtilsTest
    {
        ...
        {
            var result = Utils.UrlEncode("Test-_.~");
        ...
        {
            var result = Utils.UrlEncode("Test$%*^");
        ...
        {
            var result = Utils.ToHex(Encoding.UTF8.GetBytes(TestString));
        ...
        {
            var expectedHash = new byte[] { 106, 120, 238, 51, 86, 30, 87, 173, 232, 197, 95, 132,155,
                183, 80, 81, 25, 213, 212, 241, 218, 201, 168, 17, 253, 143, 54, 226, 42, 118, 61, 54 };
            var keyedHash = Utils.GetKeyedHash(Encoding.UTF8.GetBytes("testKey"), TestString);
